...
export class ColumnVectorIndividual {
    ...
    clone() {
        let newIndividual = new ColumnVectorIndividual(this.mutationName, this.crossoverName);
        for (let i = 0; i < 8; i++){
...
export function validateColumnVectorIndividual() {
    console.log("test generation")
    let a = new ColumnVectorIndividual();
    ...
    let b = new ColumnVectorIndividual();
    a.values = [1,1,1,1,1,1,1,1]
    b.values = [2,2,2,2,2,2,2,2]
